...
func (in *GitRepositoryStatus) DeepCopyInto(out *GitRepositoryStatus) {
	*out = *in
	...
	if in.PropagateStatus != nil {
		in, out := &in.PropagateStatus, &out.PropagateStatus
		*out = make([]MCPPropagateState, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MCPPropagateState) DeepCopyInto(out *MCPPropagateState) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MCPPropagateState.
func (in *MCPPropagateState) DeepCopy() *MCPPropagateState {
	if in == nil {
		return nil
	}
	out := new(MCPPropagateState)
	in.DeepCopyInto(out)
	return out
}

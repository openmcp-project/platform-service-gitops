...
// Package v1alpha1 contains API Schema definitions for the github.gitops.open-control-plane.io/v1alpha1 API group.
// +kubebuilder:object:generate=true
// +groupName=github.gitops.open-control-plane.io
package v1alpha1
...
var GroupVersion = schema.GroupVersion{Group: "github.gitops.open-control-plane.io", Version: "v1alpha1"}
